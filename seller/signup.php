...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($username_check <= 0){
        ...
        if($password == $cpassword && $password != ""){
            $sql = "INSERT INTO `seller` (`id`, `username`, `name`,`email`, `password`) VALUES (NULL, '$username', '$name','$email', '$password')";
...
<div class="containers">
    <form action="signup.php" method="POST" autocomplete="off">
        <h1 STYLE="padding: 5px; margin-right: auto; margin-left: auto">SELLER SIGN UP</h1>
        <div class="login">
        ...
        <div class="login">
            <input placeholder="Email" type="email" class="email" name="email" required>
        </div>
        <div class="login">
